...
gamma_list = [0.02, 0.007, 0.003, 0.0007, 0.0003]
c_list = [0.3, 0.4, 0.7, 0.8, 2, 4, 7, 9, 12]
...
metric_list = [metrics.accuracy_score]
...
for n in range(n_cv):
    ...
    for clf_name in models_of_choice:
        ...
        results[clf_name].append({m(y_pred=predicted, y_true=y_test) for m in metric_list})
